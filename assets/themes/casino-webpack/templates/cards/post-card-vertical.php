...
<div class="post-vertical-card wrapper-white">
    <?php if (get_the_post_thumbnail($post_id)) : ?>
        <div class="post-vertical-card__img_wrapper">
            <div class="post-vertical-card__img" style="background-image: url('<?php echo get_the_post_thumbnail_url($post_id, 'full');?>')"></div>
        </div>
    <?php endif; ?>
    <div class="post-vertical-card__body">
        <h4 class="post-vertical-card__title"><?php echo get_the_title($post_id); ?></h4>
        <p class="post-vertical-card__desc"><?php echo get_the_excerpt($post_id); ?></p>
        <div class="post-vertical-card__mode">
            <p class="post-vertical-card__date"><?php echo get_the_date('d.m.Y', $post_id);?></p>
            <p class="post-vertical-card__time">
    ...
    <a class="post-vertical-card__link" title="card post link" href="<?php echo get_permalink($post_id); ?>"></a>
</div>